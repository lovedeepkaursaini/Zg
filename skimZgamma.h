...
// Tue Jan  5 16:52:01 2016 by ROOT version 6.02/05
// from TTree EventTree/Event data
// found on file: job_SinglePho_Run2015D_Oct05_miniAOD.root
//////////////////////////////////////////////////////////
...
#ifdef skimZgamma_cxx
skimZgamma::skimZgamma(TString fileName) : fChain(0) 
{
...
skimZgamma::~skimZgamma()
{
   if (!fChain) return;
   delete fChain->GetCurrentFile();
}

Int_t skimZgamma::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t skimZgamma::LoadTree(Long64_t entry)
{
...
void skimZgamma::Init(TTree *tree)
{
...
void skimZgamma::Show(Long64_t entry)
{
...
Int_t skimZgamma::Cut(Long64_t entry)
{
